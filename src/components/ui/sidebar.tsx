      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          className={cn(
            ...
            // Disable slide translate on mobile drawers: avoids black vertical strip on some Android
            // Chrome builds when RTL + transform + compositing interact badly.
            "data-[side=left]:data-starting-style:translate-x-0 data-[side=left]:data-ending-style:translate-x-0",
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>القائمة الجانبية</SheetDescription>
          </SheetHeader>
...
function SidebarMenuButton({
  ...
  // Tooltip opens toward the content area (opposite the sidebar edge).
  const tooltipSide = getTextDirection(locale) === "rtl" ? "left" : "right"
