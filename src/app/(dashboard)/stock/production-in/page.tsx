...
export default async function ProductionInPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold tracking-tight">دخول إنتاج</h1>
        <p className="text-sm text-muted-foreground mt-1">
          تسجيل بضاعة داخلة من خط الإنتاج إلى موقع مخزون. مواقع المبروم تُسجَّل
          بالربطات وبالطن، والقصائر بالطن.
        </p>
      </div>
